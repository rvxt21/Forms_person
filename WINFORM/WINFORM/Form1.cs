    ...
    public partial class Form1 : Form
    {
        ...
        public void FindStudent()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    if (listStudent[i].GetTypeStudent.ToString() == type)
                    {
                        MessageBox.Show(listStudent[i].Name);
                    }
                }
        ...
        public void InitialModel()
        {
            ...
            Student student5= new Student(121, "Ivan", "Safontev", 19,adres1, typeStudent.good);
